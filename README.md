...
This work can be seen as a first step in the spirit of the "Inverse Shade Trees" approach, being able to retrieve the appearance from an image as a graph of nodes and edit it interactively. This work also tries to mix Research, Industry and Art to enhance the creativity and the productivity of artists. We think that node-based texturing tools such as Substance Designer could benefit from this kind of "art-directable" textures and materials to create complex appearances.
